...
| 2 | Άσκηση γραμμής εντολών (arch linux install) |[link] (https://wiki.archlinux.org/title/USB_flash_installation_medium) |60% καθώς η παράδοση του παραδοτέου ήταν εκτός προθεσμίας |

...
| 2 | Άσκηση γραμμής εντολών (arch linux install) |[Σύνδεσμος Ομάδας](https://wiki.archlinux.org/title/USB_flash_installation_medium) [Συγγραφή](https://github.com/courses-ionio/hci/discussions/1956) |60% καθώς η παράδοση του παραδοτέου ήταν εκτός προθεσμίας |
